...
if __name__ == "__main__":
    ...
    log_file_path_1 = 'new_results_d_1.1085609' # <--- IMPORTANT: Change this to your actual log file path
    ...
    try:
        ...
        exit()
    log_file_path_2 = 'new_results_d_2.1085608' 
    #Uproj and LSTR
    log_file_path_3 = 'new_results_d_2.1098871' 
    log_file_path_4 = 'd_13_14_15.1098872'
    log_file_path_5 = 'new_results_d_1.1098870'
    


    try:
        with open(log_file_path_2, 'r') as f:
            log_data_2 = f.read()
    except FileNotFoundError:
        print(f"Error: The file '{log_file_path_2}' was not found.")
        print("Please make sure your experiment results are saved in a text file")
        print("and update the 'log_file_path' variable in the script.")
        exit()
    except Exception as e:
