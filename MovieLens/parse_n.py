...
if __name__ == "__main__":
    ...
    log_file_path = 'new_results_n.1099401' 
    ...
    df = parse_experiment_log(log_data)
    ...
    plt.ylim(1, 1.7)
    plt.xlabel('Number of Voters (n)', fontsize=20)
    plt.ylabel('Utility Distortion', fontsize=20)
    ...
    plt.tight_layout()
    plt.savefig('n_emprical_distortion.png')
    ...
    sns.despine()
    plt.xlabel('Number of Voters (n)', fontsize=20)
    plt.ylabel('Preference Distortion', fontsize=20)
    plt.xticks(df['n'].unique())
    ax.tick_params(axis='both', labelsize=20)
    #plt.legend(title='Rule', bbox_to_anchor=(1.05, 1), loc='upper left', fontsize=15)
    leg = ax.legend(bbox_to_anchor=(1.05, 1), loc='upper left', fontsize=15)
    ...
    leg_lines[7].set_linestyle(":")
    plt.tight_layout()
    plt.savefig('n_theoretical_distortion.png')
    ...
    leg_lines[7].set_linestyle(":")
    plt.tight_layout()
    plt.savefig('n_running_time.png')
